...
Небольшой пет-проект — интернет-магазин электроники на стеке PERN (Postgres + Express + React + Node). Реализовано: регистрация/авторизация с JWT, загрузка изображений товаров, CRUD для типов, брендов и устройств, пагинация и базовая админ-часть.
